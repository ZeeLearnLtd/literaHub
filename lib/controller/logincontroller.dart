      ...
      if(token.isNotEmpty){
        ...
        if (loginResp != null && loginResp is UserResponse) {
          ...
          print('in 32....');
            ...
            box.put(LocalConstant.KEY_IS_FRADOM, loginResp.root!.subroot!.isfreedomaccess);
            box.put(LocalConstant.KEY_FRADOM_SCHOOLCODE, loginResp.root!.subroot!.freedom_code);
            print('School COde ${loginResp.root!.subroot!.freedom_code}');
          final prefs = await SharedPreferences.getInstance();
          return loginResp;
